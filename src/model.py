...
class GCN_Geo(torch.nn.Module):
    def __init__(self, initial_dim_gcn, edge_dim_feature,
        ...
        self.linear2 = nn.Linear(hidden_dim_nn_1, hidden_dim_fcn_2)
        self.linear3 = nn.Linear(hidden_dim_nn_2, hidden_dim_fcn_3)
...
""" class GCN_Geo(torch.nn.Module):
    def __init__(self, initial_dim_gcn, edge_dim_feature,
        ...
        self.linear1 = nn.Linear(hidden_dim_nn_1, hidden_dim_fcn_1)
